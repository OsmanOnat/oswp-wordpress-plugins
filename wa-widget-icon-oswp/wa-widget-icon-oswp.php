...
final class OSWP_Whatsapp
{
    ...
    private function createConstant()
    {
        ...
        defined( "WHATSAPP_PLUGIN_IMAGE_PATH" ) || define( "WHATSAPP_PLUGIN_IMAGE_PATH", plugin_dir_path( __FILE__ ) . "admin/images/" );
        defined( "WHATSAPP_PLUGINS_URL_IMAGE" ) || define( "WHATSAPP_PLUGINS_URL_IMAGE", plugins_url( '/wa-widget-icon-oswp/admin/images/' ) );
        ...
        defined( "WHATSAPP_PLUGINS_ADMIN_IMAGE_UPLOAD" ) || define( "WHATSAPP_PLUGINS_ADMIN_IMAGE_UPLOAD", WHATSAPP_PLUGIN_PATH . 'admin/images/' );
        defined( "WHATSAPP_PLUGINS_ADMIN_URL" ) || define( "WHATSAPP_PLUGINS_ADMIN_URL", WHATSAPP_PLUGIN_PATH . 'admin/' );
    ...
    public function deactive()
    {
        ...
        //admin enqueue
        remove_action( 'admin_enqueue_scripts', 'add_enqueue_custom_style_script' );

        //admin menu
        remove_action( 'admin_menu', 'oswp_whatsapp_menu' );

        //client-frontend
        remove_action( 'get_footer' , 'viewWhatsappIcon' );
    }
