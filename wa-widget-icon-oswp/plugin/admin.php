...
if( file_exists( WHATSAPP_PLUGIN_PATH . "plugin/admin-support.php" ) )
{
    require WHATSAPP_PLUGIN_PATH . "plugin/admin-support.php";
}
...
<style>
    <?php require WHATSAPP_PLUGIN_PATH . "plugin/css/custom-admin.css"; ?>
</style>
                ...
                <form action="<?= $plugin_url ?>" method="post" enctype="multipart/form-data" id="<?= WHATSAPP_PLUGIN_PREFIX ?>file_upload_form_class">
                    <div class="flex">
                        ...
                        <input 
                            ...
                            value="Send File" name="file_submit"
                        />
            ...
            <td>
                <form action="<?= $plugin_url ?>" method="post" id="<?= WHATSAPP_PLUGIN_PREFIX ?>phone_number_form">
                    ...
                    <input 
                        ...
                        value="Save" name="<?= WHATSAPP_PLUGIN_PREFIX?>phone_number_input"
                        id="phone_button_save"
                    />
                    
                    <input 
                        type="submit" class="button button-primary phone_button_remove" 
                        style="background: #d63638;border-color: #d63638;" value="Delete" 
